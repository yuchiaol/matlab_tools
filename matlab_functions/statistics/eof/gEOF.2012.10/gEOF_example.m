...
%I/O information.
dataset='sst'; %name of input data set [string].
indir='./example/'; %input dir [string].
infile='sst_example'; %input file (do NOT include suffix) [string].
...
year_analyzed_start=1901; %[integer].
year_analyzed_end=2001; %[integer].
...
%EOF mode selection.
num_modes_rot=3; %Number of modes to rotate, if applicable [integer].
num_modes_out=3; %Number of modes to write to output file [integer].
