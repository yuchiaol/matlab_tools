function [thetao lon_enso lat_enso] = ORAS4_enso_eof_region(year,var,FLAG_run)
...
enso_latS=-30;enso_latN=30;
enso_lonW=120;enso_lonE=(180-80)+180;
...
for II = 1:length(vartxt);
   ...
   load /raid/yuchiao/runoff/EC_ORAS4/MAT/ENSO/enso_eof_region.mat
end
...
if (FLAG_matsave == 1);
   ...
   save /raid/yuchiao/runoff/EC_ORAS4/MAT/ENSO/enso_eof_region.mat
end
